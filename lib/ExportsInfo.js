...
class ExportsInfo {
	 ...
	 * @returns {void}
	 */
	resetProvidedExports() {
		for (const exportInfo of this._exports.values()) {
			exportInfo.resetProvideInfo();
		}
		this._redirectTo = undefined;
		this._otherExportsInfo.resetProvideInfo();
	}
	...
	resetUsedExports() {
		for (const exportInfo of this._exports.values()) {
			exportInfo.resetUseInfo();
		}
		this._otherExportsInfo.resetUseInfo();
		this._sideEffectsOnlyInfo.resetUseInfo();
	}
