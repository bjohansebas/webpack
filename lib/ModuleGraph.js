...
class ModuleGraph {
	constructor() {
		...
		// experiments.incremental: when set, move/copyOutgoingModuleConnections record
	 ...
	 * @returns {void}
	 */
	removeStaleOutgoingConnections(module, staleDependencies) {
	 ...
	 * @returns {void}
	 */
	flushUnassignedConnections(module) {
		const mgm = this._getModuleGraphModule(module);
